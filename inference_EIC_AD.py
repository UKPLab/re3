...
def main():
    ...
    task_name = 'edit_intent_classification_AD' # task_name in ['edit_intent_classification_M','edit_intent_classification_AD', 'revision_alignment','review_request_extraction']
    ...
    icl_dynamic_file = Path(f'resource/EIC_AD_test_icl_roberta_cosine.pt')
